...
The base step is formed by diagonal preconditioning, eigentruncation, KL-target scaling, and an infinity-norm cap on the latent update. The line search then proposes
