...
\begin{itemize}
    ...
    \item the default target-mixing rule uses a $5\%$ tolerance band for both cycle free energies and replayed observables unless a target-specific tolerance is supplied explicitly,
